...
# os.environ['KIVY_WIND `OW'] = 'egl_rpi'
...
sys.path.append("/home/soft-dev/Documents/dpea-odrive/KivyTemplate/")
...
od = find_odrive()
ax = ODriveAxis(od.axis1, current_lim=50, vel_lim=10)
...
class MainScreen(Screen):
    ...
    def spinalittle(self):
        ax.set_pos(ax.get_pos()-1)


    def spinalittle1(self):
        ax.set_pos(ax.get_pos()+1)
